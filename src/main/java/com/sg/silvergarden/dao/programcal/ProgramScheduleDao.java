...
public class ProgramScheduleDao {
    ...
    public int updateProgramSchedule(Map<String, Object> pmap) {
        ...
        System.out.println("PS_NAME: " + pmap.get("PS_NAME")); //PS_NAME: PS_NAME: aaa
        System.out.println("PS_START: " + pmap.get("PS_START")); //PS_START: 2024-02-01T23:21
        System.out.println("PS_END: " + pmap.get("PS_END")); //PS_END: 2024-02-03T23:21
        System.out.println("PS_CATEGORY: " + pmap.get("PS_CATEGORY")); //PS_END: 2024-02-03T23:21
        System.out.println("PS_INFO: " + pmap.get("PS_INFO")); //PS_END: 2024-02-03T23:21
